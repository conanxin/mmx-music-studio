...
# README Phase History Archive

This file preserves the long historical README content that used to live on the repository homepage.

The current homepage README is intentionally short and focused on `v0.5.0-public-lite-byok`.
