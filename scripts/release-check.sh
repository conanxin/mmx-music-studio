...
echo "[5/25] Safe-default UI copy smoke test..."
...
# ── 6. Server smoke test ──────────────────────────────────────────────────
echo "[6/25] BYOK live attempt consume guard smoke test..."
...
echo "[7/25] BYOK live provider error observability smoke test..."
...
# ── 8. Server smoke test ────────────────────────────────────────────────
echo "[8/25] BYOK music-2.6 lyrics/instrumental param smoke test..."
...
echo "[9/25] BYOK self-use live window script smoke test..."
...
echo "[10/25] BYOK self-use Library result handling smoke test..."
...
echo "[11/25] BYOK self-use Library persistence design smoke test..."
...
echo "[12/25] BYOK self-use Library persist API smoke test..."
...
echo "[13/25] BYOK self-use Studio save-to-library UI smoke test..."
...
echo "[14/25] BYOK multi-user P3A access/Library boundary smoke test..."
...
echo "[15/25] BYOK multi-user P3B Library workspace namespace smoke test..."
...
echo "[16/25] BYOK multi-user P3C session/workspace quota smoke test..."
...
echo "[17/25] BYOK multi-user P3C1 five-user invite/session smoke test..."
...
echo "[18/25] BYOK multi-user P3C2 access context route gates smoke test..."
...
echo "[21/25] CLI adapter smoke test..."
...
echo "[22/25] Existing CLI track verification..."
