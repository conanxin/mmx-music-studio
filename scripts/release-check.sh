...
echo "[5/22] Safe-default UI copy smoke test..."
...
# ── 6. Server smoke test ──────────────────────────────────────────────────
echo "[6/22] BYOK live attempt consume guard smoke test..."
...
echo "[7/22] BYOK live provider error observability smoke test..."
...
# ── 8. Server smoke test ────────────────────────────────────────────────
echo "[8/22] BYOK music-2.6 lyrics/instrumental param smoke test..."
...
echo "[9/22] BYOK self-use live window script smoke test..."
...
echo "[10/22] BYOK self-use Library result handling smoke test..."
...
echo "[11/22] BYOK self-use Library persistence design smoke test..."
...
echo "[12/22] BYOK self-use Library persist API smoke test..."
...
echo "[13/22] BYOK self-use Studio save-to-library UI smoke test..."
...
echo "[14/22] BYOK multi-user P3A access/Library boundary smoke test..."
...
echo "[15/22] BYOK multi-user P3B Library workspace namespace smoke test..."
...
echo "[18/22] CLI adapter smoke test..."
...
echo "[19/22] Existing CLI track verification..."
