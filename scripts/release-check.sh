...
echo "[5/27] Safe-default UI copy smoke test..."
...
# ── 6. Server smoke test ──────────────────────────────────────────────────
echo "[6/27] BYOK live attempt consume guard smoke test..."
...
echo "[7/27] BYOK live provider error observability smoke test..."
...
# ── 8. Server smoke test ────────────────────────────────────────────────
echo "[8/27] BYOK music-2.6 lyrics/instrumental param smoke test..."
...
echo "[9/27] BYOK self-use live window script smoke test..."
...
echo "[10/27] BYOK self-use Library result handling smoke test..."
...
echo "[11/27] BYOK self-use Library persistence design smoke test..."
...
echo "[12/27] BYOK self-use Library persist API smoke test..."
...
echo "[13/27] BYOK self-use Studio save-to-library UI smoke test..."
...
echo "[14/27] BYOK multi-user P3A access/Library boundary smoke test..."
...
echo "[15/27] BYOK multi-user P3B Library workspace namespace smoke test..."
...
echo "[16/27] BYOK multi-user P3C session/workspace quota smoke test..."
...
echo "[17/27] BYOK multi-user P3C1 five-user invite/session smoke test..."
...
echo "[18/27] BYOK multi-user P3C2 access context route gates smoke test..."
...
echo "[19/27] BYOK multi-user P3C3 session store mock gate smoke test..."
...
echo "[20/27] BYOK multi-user P3C4 route gate enforcement smoke test..."
...
echo "[23/27] CLI adapter smoke test..."
...
echo "[24/27] Existing CLI track verification..."
