...
echo "[5/26] Safe-default UI copy smoke test..."
...
# ── 6. Server smoke test ──────────────────────────────────────────────────
echo "[6/26] BYOK live attempt consume guard smoke test..."
...
echo "[7/26] BYOK live provider error observability smoke test..."
...
# ── 8. Server smoke test ────────────────────────────────────────────────
echo "[8/26] BYOK music-2.6 lyrics/instrumental param smoke test..."
...
echo "[9/26] BYOK self-use live window script smoke test..."
...
echo "[10/26] BYOK self-use Library result handling smoke test..."
...
echo "[11/26] BYOK self-use Library persistence design smoke test..."
...
echo "[12/26] BYOK self-use Library persist API smoke test..."
...
echo "[13/26] BYOK self-use Studio save-to-library UI smoke test..."
...
echo "[14/26] BYOK multi-user P3A access/Library boundary smoke test..."
...
echo "[15/26] BYOK multi-user P3B Library workspace namespace smoke test..."
...
echo "[16/26] BYOK multi-user P3C session/workspace quota smoke test..."
...
echo "[17/26] BYOK multi-user P3C1 five-user invite/session smoke test..."
...
echo "[18/26] BYOK multi-user P3C2 access context route gates smoke test..."
...
echo "[19/26] BYOK multi-user P3C3 session store mock gate smoke test..."
...
echo "[22/26] CLI adapter smoke test..."
...
echo "[23/26] Existing CLI track verification..."
