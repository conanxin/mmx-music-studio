...
echo "[5/19] Safe-default UI copy smoke test..."
...
# ── 6. Server smoke test ──────────────────────────────────────────────────
echo "[6/19] BYOK live attempt consume guard smoke test..."
...
echo "[7/19] BYOK live provider error observability smoke test..."
...
# ── 8. Server smoke test ────────────────────────────────────────────────
echo "[8/19] BYOK music-2.6 lyrics/instrumental param smoke test..."
...
echo "[9/19] BYOK self-use live window script smoke test..."
...
echo "[10/19] BYOK self-use Library result handling smoke test..."
...
echo "[11/19] BYOK self-use Library persistence design smoke test..."
...
echo "[12/19] BYOK self-use Library persist API smoke test..."
...
echo "[15/19] CLI adapter smoke test..."
...
echo "[16/19] Existing CLI track verification..."
